...
!-----------------------------------------------------------------------
   ...
   type :: interp_bilinear_type
      ...
      real(r8), allocatable :: areacorner(:,:)
   ...
   CONTAINS
      ...
      procedure, PUBLIC :: set_missing_value => interp_bilinear_set_missing_value

      procedure, PUBLIC :: grid2pset   => interp_bilinear_grid2pset_2d
      procedure, PUBLIC :: grid2corner => interp_bilinear_grid2corner_2d
      procedure, PUBLIC :: corner2grid => interp_bilinear_corner2grid_2d
      procedure, PUBLIC :: corner2pset => interp_bilinear_corner2pset_2d
...
CONTAINS
   ...
   !-----------------------------------------------------
   SUBROUTINE interp_bilinear_set_missing_value (this, gdata, missing_value, pmask)
   ...
   type(pointer_real8_1d), allocatable :: pbuff(:)
      ...
      ENDIF
   END SUBROUTINE interp_bilinear_set_missing_value 
   
   !-----------------------------------------------------
   SUBROUTINE interp_bilinear_interp_2d (this, gdata, pdata)
   ...
   END SUBROUTINE interp_bilinear_interp_2d


   !-----------------------------------------------------
   SUBROUTINE interp_bilinear_get_corners (this, gdata, pdata)
      ...
      IF (p_is_worker) THEN
         ...
         DO iset = 1, this%npset
            DO ig = 1, 4
               ...
               iloc  = this%address(2,ig,iset)
               IF (iloc > 0) THEN
                  pdata(ig,iset) = pbuff(iproc)%val(iloc)
               ENDIF
            ENDDO
         ENDDO
   ...
   END SUBROUTINE interp_bilinear_get_corners

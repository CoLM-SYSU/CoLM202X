...
SUBROUTINE Aggregation_Urban (dir_rawdata, dir_srfdata, lc_year, &
   ...
   IF (p_is_worker) THEN
      ...
      DO iurban = 1, numurban
         CALL aggregation_request_data (landurban, iurban, grid_urban_5km, zip = .false., &
   ...
   IF (p_is_worker) THEN
      ...
      DO iurban = 1, numurban
         ...
         CALL aggregation_request_data (landurban, iurban, grid_urban_500m, zip = .false., &
   ...
   IF (p_is_worker) THEN
      ...
      DO iurban = 1, numurban
         CALL aggregation_request_data (landurban, iurban, grid_urban_500m, zip = .false., area = area_one, &

...
CONTAINS
   ...
   SUBROUTINE aggregation_data_daemon (grid_in, &
         ...
         data_r8_3d_in3, n1_r8_3d_in3  , data_r8_3d_in4, n1_r8_3d_in4)
   ...
   SUBROUTINE aggregation_request_data (     &
      ...
      DO iproc = 0, p_np_io-1
         ...
         IF (nreq > 0) THEN
            ...
            IF (present(data_r8_3d_in3) .and. present(data_r8_3d_out3) .and. present(n1_r8_3d_in3)) THEN
               allocate (rbuf_r8_2d (n1_r8_3d_in3,nreq))
               CALL mpi_recv (rbuf_r8_2d, n1_r8_3d_in3*nreq, MPI_REAL8, &
                  isrc, mpi_tag_data, p_comm_glb, p_stat, p_err)
               CALL unpack_inplace (rbuf_r8_2d, msk, data_r8_3d_out3)
               deallocate (rbuf_r8_2d)
            ENDIF

            IF (present(data_r8_3d_in4) .and. present(data_r8_3d_out4) .and. present(n1_r8_3d_in4)) THEN
               allocate (rbuf_r8_2d (n1_r8_3d_in4,nreq))
               CALL mpi_recv (rbuf_r8_2d, n1_r8_3d_in4*nreq, MPI_REAL8, &
                  isrc, mpi_tag_data, p_comm_glb, p_stat, p_err)
               CALL unpack_inplace (rbuf_r8_2d, msk, data_r8_3d_out4)
               deallocate (rbuf_r8_2d)
            ENDIF

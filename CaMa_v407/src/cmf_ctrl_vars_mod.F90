...
USE YOS_CMF_INPUT,           ONLY: LOGNAM, LDAMOUT, LLEVEE, LWEVAP, LWINFILT,LOUTINS
IMPLICIT NONE
CONTAINS 
!####################################################################
! -- CMF_PROG_INIT      : Initialize Prognostic variables (include restart data handling)
...
USE YOS_CMF_PROG,            ONLY: ND2PROG,      D2PROG,       D2DAMMY,  &
                                 ...
                                 & D2DAMSTO,     D2DAMINF,     D2LEVSTO ,    D2WEVAP  ,D2WINFILT   !! optional
IMPLICIT NONE
!*** LOCAL
...
IF ( LWINFILT  ) ND2PROG=ND2PROG+1 !! input Infiltration (D2WINFILTs)

#!/bin/zsh
# code for offset time axis of ERA5LAND u10 (1hour)
...
SYear=2000
EYear=2000
varnames="10m_v_component_of_wind"
Months="12"
#Months="12"
...
#        for Month in ${Months};do
        #cdo -b F32 -f nc4c -z zip_6 settaxis,${SYear}-${Month}-01,00:30:00,1hour ${source}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}.nc4  $Out/ERA5LAND_${SYear}_${Month}_${varname}.nc
#            cdo -b F32 -f nc4c -z zip_6 -shifttime,-1hour -setcalendar,standard ${source}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}.nc4  $DIR/ERA5LAND_${SYear}_${Month}_${varname}.nc
#        done
#        SYear=`expr $SYear + 1`
#    done
#done

#!/bin/zsh
# code for offseting time axis of ERA5LAND surface_thermal_radiation_downwards data (1hour), and convert it to hourly areverage data from accumulation data.
# prepared by: zhongwang Wei @ SYSU 2021-10-20, Zhongwang007@gmail.com

ifort times.f newtime.f -o newtime
DIR=./scratch
source=../../data/surface_thermal_radiation_downwards/
SYear=1979
EYear=1979
varnames="surface_thermal_radiation_downwards"
...
for varname in ${varnames}; do
    ...
    while [ ${SYear} -le ${EYear} ] ; do
        for Month in ${Months};do
            ...
            cdo setattribute,strd@units="w/m2" ${DIR}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}_w_m2_temp1.nc ${DIR}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}_w_m2_temp2.nc
            cdo expr,'strd=strd/3600' ${DIR}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}_w_m2_temp2.nc ${DIR}/${varname}/ERA5LAND_${SYear}_${Month}_${varname}_w_m2_temp3.nc

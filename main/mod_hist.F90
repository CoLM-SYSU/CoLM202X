...
module mod_hist
   ...
   interface hist_write_var
      module procedure hist_write_var_real8_2d
      module procedure hist_write_var_real8_3d
      module procedure hist_write_var_real8_4d
   end interface hist_write_var 
...
contains
   ...
   SUBROUTINE hist_out (idate, deltim, itstamp, ptstamp, &
      ...
      if (lwrite)  then
         ...
         call flux_map_and_write_3d ( DEF_hist_vars%lake_icefrac, &
            ...
            'lake', itime_in_file, sumwt, filter)
            ...
            do iblk = 1, gblock%nxblk
               ...
               if (gblock%pio(iblk,jblk) == p_iam_glb) then
                  ...
                  if (.not. fexists) then
                     ...
                     call hist_write_ginfo (fileblock, grid, iblk, jblk)
                  end if
            ...
            do iblk = 1, gblock%nxblk
               if (gblock%pio(iblk,jblk) == p_iam_glb) then
                  ...
                  if (present(compress)) then
                     ...
                     call ncio_write_serial_time (fileblock, dataname, itime, &
                        wdata%blk(iblk,jblk)%val, 'lon', 'lat', 'time')
                  end if
            ...
            do iblk = 1, gblock%nxblk
               if (gblock%pio(iblk,jblk) == p_iam_glb) then
                  ...
                  if (present(compress)) then
                     ...
                     call ncio_write_serial_time (fileblock, dataname, itime, &
                        wdata%blk(iblk,jblk)%val, dim1name, 'lon', 'lat', 'time')
                  end if
            ...
            do iblk = 1, gblock%nxblk
               if (gblock%pio(iblk,jblk) == p_iam_glb) then
                  ...
                  if (present(compress)) then
                     ...
                     call ncio_write_serial_time (fileblock, dataname, itime, &
                        wdata%blk(iblk,jblk)%val, dim1name, dim2name, 'lon', 'lat', 'time')
                  end if
   ...
   !------------------
   subroutine hist_write_ginfo (fileblock, grid, iblk, jblk)
   ...
   end subroutine hist_write_ginfo

...
!WUE diagnostic variables
  ...
  REAL(r8) :: assim_RuBP_sun_c    (0:N_PFT-1)
  REAL(r8) :: assim_Rubisco_sun_c (0:N_PFT-1)
  REAL(r8) :: cisun_c             (0:N_PFT-1)
  REAL(r8) :: Dsun_c              (0:N_PFT-1)
  REAL(r8) :: gammasun_c          (0:N_PFT-1)
  REAL(r8) :: lambdasun_c         (0:N_PFT-1)
  REAL(r8) :: assimsha_c          (0:N_PFT-1)
  REAL(r8) :: etrsha_c            (0:N_PFT-1)
  REAL(r8) :: assim_RuBP_sha_c    (0:N_PFT-1)
  REAL(r8) :: assim_Rubisco_sha_c (0:N_PFT-1)
  REAL(r8) :: cisha_c             (0:N_PFT-1)
  REAL(r8) :: Dsha_c              (0:N_PFT-1)
  REAL(r8) :: gammasha_c          (0:N_PFT-1)
  REAL(r8) :: lambdasha_c         (0:N_PFT-1)
#endif

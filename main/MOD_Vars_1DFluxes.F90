...
!-----------------------------------------------------------------------
   ...
   real(r8), allocatable :: fsat   (:) !fraction of saturation area [-]
   ...
   IMPLICIT NONE
      ...
      IF (p_is_worker) THEN
         ...
         IF (numpatch > 0) THEN
            ...
            allocate ( fsat   (numpatch) )  ; fsat   (:) = spval ! fraction of saturation area [-]
   ...
   USE MOD_LandPatch
      ...
      IF (p_is_worker) THEN
         ...
         IF (numpatch > 0) THEN
            ...
            deallocate ( fsat    )  ! fraction of saturation area [-]

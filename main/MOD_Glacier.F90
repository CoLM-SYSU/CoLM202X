...
!=======================================================================
  ...
  use precision
  use MOD_Vars_PhysicalConst, only : hvap,hsub,rgas,cpair,stefnc,tfrz,cpliq,cpice
...
!=======================================================================
  ...
  use precision
  use MOD_Vars_PhysicalConst, only : stefnc,cpice,cpliq,denh2o,denice,tfrz,tkwat,tkice,tkair
  USE MOD_Meltf
  USE mod_utils

...
!End ozone stress variables
           ...
           allocate (irrig_rate                  (numpatch))
           allocate (deficit_irrig               (numpatch))
           allocate (sum_irrig                   (numpatch))
           allocate (sum_irrig_count             (numpatch))
           allocate (n_irrig_steps_left          (numpatch))

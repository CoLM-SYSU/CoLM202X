...
!####################################################################
   ...
   USE YOS_CMF_PROG,       only: D2RIVOUT,  D2FLDOUT,  P2RIVSTO,  P2FLDSTO,  D2RUNOFF
...
!$OMP PARALLEL DO REDUCTION(+:P0GLBSTOPRE,P0GLBRIVINF,P0GLBRIVOUT,P0GLBSTONXT,P0GLBSTONEW)
      DO ISEQ=1, NSEQALL
         ...
         P0GLBRIVINF = P0GLBRIVINF + D2RIVINF(ISEQ,1)*DT + D2FLDINF(ISEQ,1)*DT + D2PTHINF(ISEQ,1)*DT
         ...
         IF ( P2RIVSTO(ISEQ,1) < 0._JPRB ) THEN

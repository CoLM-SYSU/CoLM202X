...
NAMELIST/NDAMOUT/   CDAMFILE, LDAMTXT, LDAMYBY, LiVnorm, LDAMOPT
...
REAL(KIND=JPRB),ALLOCATABLE     :: FldVol(:)            !! flood control storage (mcm): exclusive for flood control
REAL(KIND=JPRB),ALLOCATABLE     :: NorVol(:)            !! normal storage (mcm): impoundment
REAL(KIND=JPRB),ALLOCATABLE     :: ConVol(:)            !! conservative storage (mcm): mainly for water supply

...
! WRITE(LOGNAM,*) "LHB debug line228: P0GLBSTONEW ---> ", P0GLBSTONEW
! WRITE(LOGNAM,*) "LHB debug line228: P0GLBSTOPRE2 ---> ", P0GLBSTOPRE2
! WRITE(LOGNAM,*) "LHB debug line228: P0GLBSTONEW2 ---> ", P0GLBSTONEW2
! WRITE(LOGNAM,*) "LHB debug line228: DERROR2 ---> ", DERROR2
! WRITE(LOGNAM,*) "LHB debug line228: P0GLBFLDSTO ---> ", P0GLBFLDSTO

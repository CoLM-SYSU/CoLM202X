...
!!  D2OUTFLW(ISEQ,1)=D2RIVOUT(ISEQ,1)+D2FLDOUT(ISEQ,1)+D2PTHOUT(ISEQ,1)   !! bug before v4.2 (pthout shoudl not be added)
  ...
  ! IF (ABS(D2STORGE(ISEQ,1)) .GT. 1.E15) THEN
  !   WRITE(LOGNAM, *) "LHB debug line109: ISEQ, P2RIVSTO, DRIVROF ---> ", ISEQ, P2RIVSTO(ISEQ,1), DRIVROF
  !   WRITE(LOGNAM, *) "LHB debug line110: ISEQ, P2FLDSTO, DFLDROF ---> ", ISEQ, P2FLDSTO(ISEQ,1), DFLDROF
  !   WRITE(LOGNAM, *) "LHB debug line111: ISEQ, D2RUNOFF ---> ", ISEQ, D2RUNOFF(ISEQ,1)
  !   WRITE(LOGNAM, *) "LHB debug line112: ISEQ, D2GDWRTN ---> ", ISEQ, D2GDWRTN(ISEQ,1)
  !   WRITE(LOGNAM, *) "LHB debug line113: ISEQ, D2FLDFRC ---> ", ISEQ, D2FLDFRC(ISEQ,1)
  !   WRITE(LOGNAM, *) "LHB debug line114: ISEQ, DT ---> ", ISEQ, DT
  ! ENDIF
ENDDO
!$OMP END PARALLEL DO SIMD
WRITE(LOGNAM, *) "LHB debug line118: DT ---> ", DT
CONTAINS
!==========================================================
!+ CALC_GDWDLY
!+ 
